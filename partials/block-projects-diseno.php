<div class="row more-portfolio more-projects-diseno mb-20">
	<div class="col-xs-12 col-md-10 ml-auto mr-auto portfolio mb-20">
		<div class="block-projects-container"><?php
			$args = array( 'post_type' => 'proyecto', 'tax_query' => array(array ('taxonomy' => 'categoria', 'field' => 'slug', 'terms' => 'diseno-grafico', ) ) );
